...
@Component({
  selector: 'upload-alianza',
  templateUrl: './alianzaUpload.component.html',
  styleUrls: ['./alianzaUpload.component.css'],
  standalone:true,
  providers: [AlianzaService, AuthService],
})

export class AlianzaUploadComponent implements OnInit {

  @Input() alianza!: Alianza;
