...
@Component({
  selector: 'upload2-slider',
  templateUrl: './sliderUpload2.component.html',
  styleUrls: ['./sliderUpload2.component.css'],
  providers: [ AuthService],
  standalone:true
})

export class SliderUpload2Component implements OnInit {
  ...
  subirArchivo(): void {
    ...
    if (this.archivoSeleccionado != null) {
      ...
      this.modal.origen = "subirImgMovil";
